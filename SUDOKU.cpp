...
cout<<"\t\t\t"<<char(30)<<"\n\t\t       "<<char(17)<<" "<<char(16)<<"\n\t\t\t"<<char(31);
 gotoxy(2,25);cout<<"Esc-RETURN";getch();
 }
void designer()
 {
 for(int f=0;f<6;f++)
  ...
  switch(f)
   {
   case 0:
   textcolor(WHITE);clrscr();  gotoxy(35,12);
   cout<<"S";delay(750);break;
   case 1:
   textcolor(RED);clrscr();    gotoxy(35,12);
   cout<<"SU";delay(750);break;
   case 2:
   textcolor(BLUE);clrscr();   gotoxy(35,12);
   cout<<"SUD";delay(750);break;
   case 3:
   textcolor(GREEN);clrscr();  gotoxy(35,12);
   cout<<"SUD"<<char(153);delay(750);break;
   case 4:
   textcolor(BROWN);clrscr();  gotoxy(35,12);
   cout<<"SUD"<<char(153)<<"K";delay(750);break;
   case 5:
   textcolor(YELLOW);clrscr(); gotoxy(35,12);
   cout<<"SUD"<<char(153)<<"KU";delay(750);break;
   }
  }
  for(f=0;f<12;f++)
  {
  switch(f)
   {
   case 0:
   textcolor(YELLOW);clrscr();break;
   case 1:
   textcolor(BROWN);clrscr();break;
   case 2:
   textcolor(WHITE);clrscr();break;
   case 3:
   textcolor(GREEN);clrscr();break;
   case 4:
   textcolor(BLUE);clrscr();break;
   case 5:
   textcolor(RED);clrscr();break;
   case 6:
   textcolor(YELLOW);clrscr();break;
   case 7:
   textcolor(BROWN);clrscr();break;
   ...
   gotoxy(35,12);
  cout<<"SUD"<<char(153)<<"KU";delay(750);
  }
 // gotoxy(30,12);
 // cout<<"DEVELOPED BY AKHIL MOHAN";delay(750);
}
...
//gotoxy(66,10);cout<<"Starting time:";
}
void frame()
 {         int x;
 clrscr(); gotoxy(20,6);
...
void playgame()
 ...
 do
  ...
  if(key=='0')
   ...
   {c[g].dup=0;clrscr();frame();printer();}
   }
  else
  if(key=='1')
   {g=cord(xp,yp);
   ...
   {c[g].dup=1;clrscr();frame();printer();}
   }
  else
  if(key=='2')
   {g=cord(xp,yp);
   ...
   {c[g].dup=2;clrscr();frame();printer();}
   }
  else
  if(key=='3')
   {g=cord(xp,yp);
   ...
   {c[g].dup=3;clrscr();frame();printer();}
   }
  else
  if(key=='4')
   {g=cord(xp,yp);
   ...
   {c[g].dup=4;clrscr();frame();printer();}
   }
  else
  if(key=='5')
   {g=cord(xp,yp);
   ...
   {c[g].dup=5;clrscr();frame();printer();}
   }
  else
  if(key=='6')
   {g=cord(xp,yp);
   ...
   {c[g].dup=6;clrscr();frame();printer();}
   }
  else
  if(key=='7')
   {g=cord(xp,yp);
   ...
   {c[g].dup=7;clrscr();frame();printer();}
   }
  else
  if(key=='8')
   {g=cord(xp,yp);
   ...
   {c[g].dup=8;clrscr();frame();printer();}
   }
  else
  if(key=='9')
   {g=cord(xp,yp);
   ...
   {c[g].dup=9;clrscr();frame();printer();}
   }
  else
  if(key==0)
   {
...
{ if(s[k].a[c[h].i][c[h].j]==c[h].dup)
 ...
 if(checker==-1)
 {textcolor(RED);clrscr();frame();printer();gotoxy(2,14);cout<<"\aWrong";delay(1000);
 textcolor(WHITE);clrscr();frame();printer();playgame();}
 if(pass()==1&&checker==1)       //not working properly
 {textcolor(GREEN);clrscr();gotoxy(25,10);cout<<"CONGRATULATIONS";gotoxy(25,12);cout<<"YOU HAVE WON THE SUDOKU GAME";delay(2000);textcolor(WHITE);clrscr();secmn();; }
 else
 if(checker==1)
 {textcolor(GREEN);clrscr();frame();printer();gotoxy(2,14);cout<<"Go on..You";gotoxy(2,15);cout<<"are in the correct";
 gotoxy(2,16);cout<<"path";delay(1000);textcolor(WHITE);clrscr();frame();printer();playgame();}
}
